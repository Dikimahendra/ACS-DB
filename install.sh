...
echo -e "${GREEN}=============================================================${NC}"
echo -e "${GREEN}=============================================================${NC}"
echo -e "${GREEN}=========== dddddddd     ddd   ddd   ddd  ddd ===============${NC}"
echo -e "${GREEN}=========== ddd   ddd    ddd   ddd ddd    ddd ===============${NC}"
echo -e "${GREEN}=========== ddd     dd   ddd   ddddd      ddd ===============${NC}"
echo -e "${GREEN}=========== ddd   ddd    ddd   ddd ddd    ddd ===============${NC}"
echo -e "${GREEN}=========== dddddddd     ddd   ddd   ddd  ddd ===============${NC}"
echo -e "${GREEN}=============================================================${NC}"
echo -e "${GREEN}==================== . 0899-2906-xxx . ======================${NC}"
echo -e "${GREEN}=============================================================${NC}"
echo -e "${GREEN}${NC}"
...
echo -e "${GREEN}======================================================================================${NC}"
echo -e "${RED}${NC}"
echo -e "${GREEN}Sebelum melanjutkan, Apakah anda yakin ingin melanjutkan? (y/n)${NC}"
read confirmation
...
#Sukses
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN}========== GenieACS UI akses port 3000. : http://$(ip):3000 ================${NC}"
echo -e "${GREEN}=================== Informasi: dikimahendra.epizy.com =======================${NC}"
echo -e "${GREEN}============================================================================${NC}"
